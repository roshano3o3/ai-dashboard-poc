  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isLogin) {
      ...
      if (error) {
        ...
        // ✅ FIX: go to welcome right after login
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background:
          "linear-gradient(135deg, #0a0a1f 0%, #1a1a3e 50%, #2d1b69 100%)",
        display: "flex",
        alignItems: "center",
    ...
    >
      ...
      <div
        style={{
          ...
          height: "600px",
          background:
            "radial-gradient(circle, rgba(245, 87, 108, 0.4) 0%, transparent 70%)",
          borderRadius: "50%",
          bottom: "-200px",
          right: "-200px",
          filter: "blur(120px)",
      ...
      <div
        style={{
          ...
          width: "100%",
          boxShadow:
            "0 40px 100px rgba(0, 0, 0, 0.7), 0 0 0 1px rgba(102, 126, 234, 0.4)",
      ...
      >
        ...
        <div
          style={{
            ...
            bottom: "-3px",
            background:
              "linear-gradient(135deg, rgba(102, 126, 234, 0.6), rgba(245, 87, 108, 0.6))",
            borderRadius: "40px",
            filter: "blur(25px)",
            opacity: 0.6,
            zIndex: -1,
        ...
        >
          <button
            ...
            style={{
              ...
              boxShadow: isLogin ? "0 6px 20px rgba(102, 126, 234, 0.5)" : "none",
              letterSpacing: "1px",
            }}
          >
            SIGN IN
